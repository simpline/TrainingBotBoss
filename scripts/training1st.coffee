...
#   boss お客様にあいさつしてきました。
#   boss サーバを立ててきました。思ったよりOSインストールに時間がかかりました。
#   boss 2日目は何をしましょうか。
#   boss NTP、DNS、DHCPを構築してきました。どういう機能なのか理解できました。
#   boss 3日目は何をしましょうか。
#   boss メールサーバを立ててきました。Postfixで構築してきました。
#   boss 4日目は何をしましょうか。
#   boss ファイルサーバを立ててきました。Windowsからも閲覧できるようにしました。
#   boss 5日目は何をしましょうか。
#   boss サーバを調べてきました。ログには特にエラーは見つかりませんでした。
